        ...
        return {
            ...
            clickTreeNodeRefreshPanel_onClick: function (panelId, url, paramName, fnCreateUrl) {
                return function (node) {
                    ...
                    $("#" + panelId).panel("refresh", fnCreateUrl(url, paramName, node));

                    //获取url
                    function getUrl(_url, _paramName, treeNode) {
                        return $.joinUrl(_url, _paramName + "=" + treeNode.id);
                    }
                };
            }
        };
