(function ($) {
    ...
    //查询工具条Id
    $.easyui.queryToolbarId = "toolbar-query";
    //表格Id
    $.easyui.gridId = "grid";
    //树Id
    $.easyui.treeId = "tree";
    ...
    $.easyui.deleteConfirmMessage = "您确定删除选中的记录吗，删除后将无法恢复，请确认？";
    ...
    $.easyui.deleteConfirmMessageForSave = "您确认要删除选中的记录吗，删除后记得保存该操作，才能生效！";
