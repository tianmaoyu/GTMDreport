...
/*henian.xu*/
var re = opts.onShow.call(_1e9, e);
if (re == 'noshow') { return; }
tip.show();
...
var win=$(_26e).panel($.extend({},_26f.options,{border:false,doSize:true,closed:true,cls:"window "+opts.cls,headerCls:"window-header",bodyCls:"window-body "+(opts.noheader?"window-body-noheader":""),onBeforeDestroy:function(){
...
function _296(_297, _298, _299, obj) {
    var win = $("<div class=\"messager-body\"></div>").appendTo("body");
    win.append(_298);
    if (_299) {
        var tb = $("<div class=\"messager-button\"></div>").appendTo(win);
        for (var _29a in _299) {
            $("<a></a>").addClass(_29a=='确定'?'primary': 'danger').attr("href", "javascript:void(0)").text(_29a).css("margin-left", 10).bind("click", eval(_299[_29a])).appendTo(tb).linkbutton();
        }
    }
    win.window($.extend({}, {
...
return _294(_29b);
},alert:function(_29c,msg,icon,fn,obj){
...
var win=_296(_29c,_29d,_29e,obj);
return win;
},confirm:function(_29f,msg,fn,obj){
...
var win = _296(_29f, _2a0, _2a1,obj);
return win;
},prompt:function(_2a2,msg,fn,obj){
...
var win=_296(_2a2,_2a3,_2a4,obj);
...
_46a.css({ width: opts.iconWidth + "px", height: tb.height() + "px", 'line-height': tb.height() + "px", 'text-align': 'center' });//henian.xu
