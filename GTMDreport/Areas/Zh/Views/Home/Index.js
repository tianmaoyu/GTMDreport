...
$(function () {
    ...
    function addDesktopTab() {
        $.easyui.addIframeToTabs("divMainTabs", "我的桌面", "/Zh/Desktop/Index", "icon-house", false);
    }
    ...
    function bindAccordionClick() {
        $("#menus li").click(function () {
            var self = $(this);
            $.easyui.addIframeToTabs("divMainTabs", self.text(), self.data("url"), self.data("icon"), true);
            bindTabsEvent();
