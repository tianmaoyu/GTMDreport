...
namespace System.Web.Mvc
{
    ...
    public abstract partial class CrudControllerAdminBase<TViewModel, TAddParameters, TEditParameters>: AdminControllerBase
        ...
        where TEditParameters : class,new()
    {
        ...
        protected CrudControllerAdminBase(IServiceBase<TViewModel, TAddParameters, TEditParameters> serviceBase)
        {
    ...
    public abstract partial class CrudControllerAdminBase<TViewModel, TAddParameters, TEditParameters, TFindAnyParameters> : CrudControllerAdminBase<TViewModel, TAddParameters, TEditParameters>
        where TViewModel : class,new()
        where TAddParameters : class,new()
        where TEditParameters : class,new()
        where TFindAnyParameters : class, IPagination
    {
        ...
        /// </summary>
        /// <param name="serviceBase">表示一个基础服务。</param>
        protected CrudControllerAdminBase(IServiceBase<TViewModel, TAddParameters, TEditParameters, TFindAnyParameters> serviceBase)
            : base(serviceBase)
        {
            this.ServiceBase = serviceBase;
        }
