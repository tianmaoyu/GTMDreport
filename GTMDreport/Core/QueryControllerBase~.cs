...
{
    public abstract class QueryControllerAdminBase<TViewModel, TFindAnyParameters> : AdminControllerBase
        ...
        where TFindAnyParameters :class, IPagination
    {
        ...
        protected QueryControllerAdminBase(IServiceBase<TViewModel, TFindAnyParameters> serviceBase)
        {
